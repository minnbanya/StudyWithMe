...
class MentorsTest < ApplicationSystemTestCase
  ...
  test "should create mentor" do
    ...
    fill_in "Emailaddress", with: @mentor.emailAddress
    fill_in "Mentorid", with: @mentor.mentorId
    fill_in "Name", with: @mentor.name
    fill_in "Password", with: @mentor.password
    fill_in "Phonenumber", with: @mentor.phoneNumber
    check "Verificationstatus" if @mentor.verificationStatus
